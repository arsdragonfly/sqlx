...
use sqlx_core::{connection::Connection, sql_str::SqlStr, statement, transaction::TransactionManager};
...
impl TransactionManager for DuckDBTransactionManager {
    ...
    fn begin(conn: &mut DuckDBConnection, statement: Option<SqlStr>) -> BoxFuture<'_, Result<(), sqlx_core::Error>> {
